...
import com.gistone.bjhky.service.ISt4SysSaService;
...
public class TaskController {
    ...
    public Result insertTask(@RequestBody @ApiParam(name = "任务批次添加接口", value = "json格式", required = true) Swagger<St4ScsCl> data, HttpServletRequest request) {
        St4ScsCl param = data.getData();
    ...
    public Result updateTask(@RequestBody @ApiParam(name = "任务批次修改接口", value = "json格式", required = true) Swagger<St4ScsCl> data) {
        St4ScsCl param = data.getData();
        if(param.getCl001()==null){
            return  Result.build(1001,"批次任务ciId"+ResultMsg.MSG_1001);
        }
    ...
    public Result deleteTask(@RequestBody @ApiParam(name = "任务批次修改接口", value = "json格式", required = true) Swagger<St4ScsCl> data) {
        St4ScsCl param = data.getData();
        if(param.getCl001()==null){
            return  Result.build(1001,"批次任务ciId"+ResultMsg.MSG_1001);
        }
    ...
    public Result listTask(@RequestBody @ApiParam(name = "任务批次列表接口", value = "json格式", required = true) Swagger<St4ScsCl> data,HttpServletRequest request) {
        St4ScsCl param = data.getData();
    ...
    public Result listTaskSelect(@RequestBody @ApiParam(name = "任务批次下拉框列表接口", value = "json格式", required = true) Swagger<St4ScsCl> data) {
        St4ScsCl param = data.getData();
