...
public class St4ScsCk extends BaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "是否处罚(1是 0否)",dataType = "Integer",example = "1")
    @TableField("CK039")
    ...
    @ApiModelProperty(value = "是否四类聚焦(1是 0否)",dataType = "Integer",example = "1")
    @TableField("CK080")
    private Integer ck080;

    @ApiModelProperty(value = "是否巡查台账(1是 0否)",dataType = "Integer",example = "1")
    @TableField("CK081")
    private Integer ck081;

    @ApiModelProperty(value = "是否市级巡查(1是 0否)",dataType = "Integer",example = "1")
    @TableField("CK082")
    private Integer ck082;

    @ApiModelProperty(value = "是否国家点(1是 0否)",dataType = "Integer",example = "1")
    @TableField("CK083")
    private Integer ck083;

    @ApiModelProperty(value = "是否重点台账(1是 0否)",dataType = "Integer",example = "1")
    @TableField("CK084")
    ...
    @ApiModelProperty(value = "(绿盾使用，将类型改为varchar)是否是原始台账 0不是 1是 默认1",dataType = "Integer",example = "1")
    @TableField("CK088")
     ...
     */
    @TableField(exist = false)
    @ApiModelProperty(value="任务批次年份",example = "2000")
    private String yyyy;
    @TableField(exist = false)
    ...
    @TableField(exist = false)
    @ApiModelProperty(value="下发级别(1市级,2国家)",example = "2")
    private Integer xfjb;
...
@Ignore
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), ck002, cd004, sg001, ck005, ck006, ck007, ck008, ck009, ck010, ck011, ck012, ck013, ck014, ck015, ck016, ck017, ck018, ck019, ck020, ck021, ck022, ck023, ck024, ck025, ck026, ck027, ck028, ck029, ck030, ck031, ck032, ck033, ck034, ck035, ck036, ck037, ck038, ck039, ck040, ck041, ck042, ck043, ck044, ck045, ck046, ck047, ck048, ck049, ck050, ck051, ck052, ck053, ck054, ck055, ck056, ck057, ck058, ck059, ck060, ck061, ck062, ck063, ck064, ck065, ck066, ck067, ck068, ck069, ck070, ck071, ck072, cc002, ck074, ck075, ck076, ck077, ck078, ck079, ck080, ck081, ck082, ck083, ck084, ck085, ck086, ck087, ck088, ck089, ck090, ck091, checkLedgerAttach, st4ScsCd, processStatus, st4ScsCn, st4ScsCl, st4ScsCb, st4SysSg, st4SysSd, st4ScsCnList, st4ScsCz, yyyy, cl001, bhqmc, xfjb, wzg, zgz, zgwc, wxzg, SG008, SD008, type, num, ptype);
    }
}
