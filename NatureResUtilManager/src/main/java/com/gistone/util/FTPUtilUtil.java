...
//            ftpClient.setControlEncoding("UTF-8"); // 中文支持
    ...
    public static String uploadFileCheckUse(String ftpHost, String ftpUserName, String ftpPassword, int ftpPort,String ftpPath, String fileName, InputStream input) {
        String isItDone = null;
        FTPClient ftp = null;
        try {
            String ftpPaths=new String(ftpPath.getBytes("GBK"),"iso-8859-1");
