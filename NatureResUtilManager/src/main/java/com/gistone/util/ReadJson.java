...
public class ReadJson {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String aa = "101.63##36.6,102.36##36.5";
        String[] a = aa.split(",");
        writeGeoJson(a, "D:/@/nr_line/123.json");

    }
    //构造轨迹路线json文件
    public static String writeGeoJson(String[] array, String path) throws IOException {
        //构造geojson格式数据
     ...
     * @throws IOException
     */
    public static String writeGeoJsonList(List<String[]> list, String path) throws IOException {
        //构造geojson格式数据
        String geoJson = "{'type':'FeatureCollection','features':[";
        JSONArray coordinatesList = new JSONArray();
        for(int i = 0 ; i < list.size() ; i++){
