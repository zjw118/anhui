...
public ResultVO add(@RequestBody LsDataStrategy entity, BindingResult bindingResult){
...
public ResultVO update(@RequestBody LsDataStrategy entity,BindingResult bindingResult){
if (bindingResult.hasErrors()) {
return ResultVOUtil.error(ResultEnum.ERROR.getCode(), bindingResult.getAllErrors().get(0).getDefaultMessage());
}
//判断更新人加人是否为空
