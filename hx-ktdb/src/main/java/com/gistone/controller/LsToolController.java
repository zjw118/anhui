...
public class LsToolController {
    ...
    public ResultVO add(LsTool entity, BindingResult bindingResult, MultipartFile file) {
    ...
    public ResultVO update( LsTool entity, BindingResult bindingResult, MultipartFile file) {
        if (bindingResult.hasErrors()) {
            return ResultVOUtil.error(ResultEnum.ERROR.getCode(), bindingResult.getAllErrors().get(0).getDefaultMessage());
        }
